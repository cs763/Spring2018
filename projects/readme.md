...
<img src="glyphs_sample.png"> 
<li><b>Glyph based AR application:</b> Images above depict typical glyphs. You job is to develop an appication which tracks these glyphs, computes homography, and overlays 3D graphics over it, as in typical AR application.
